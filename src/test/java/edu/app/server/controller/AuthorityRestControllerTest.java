...
public class AuthorityRestControllerTest {
    ...
    @Test
    public void whenGetRequestAllAuthorities() throws Exception {
        MediaType textPlainUtf8 = new MediaType(MediaType.TEXT_PLAIN, StandardCharsets.UTF_8);
        mockMvc.perform(MockMvcRequestBuilders.get("/authority/all")
                .header("Authorization", adminToken))
                .andExpect(status().isOk());
    }

    @Test
    public void whenPostRequestGetAuthority() throws Exception {
        MediaType textPlainUtf8 = new MediaType(MediaType.TEXT_PLAIN, StandardCharsets.UTF_8);
        mockMvc.perform(MockMvcRequestBuilders.post("/authority/get/1")
                .header("Authorization", adminToken))
                .andExpect(status().isOk());
    }
}
